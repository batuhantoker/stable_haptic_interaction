...
vars = [v_d,v_v,F_v,v_m,F_c,F_int];
eqns = [eqn5,eqn6,eqn7,eqn8,eqn9,eqn1];
sol = solve(eqns,vars)
F_int=sol.F_int
%v_h=sol.v_h
ss=symvar(F_int);
...
Z_d=poly2sym(str2sym('[0 0]'))/(poly2sym(str2sym('[1 0]')))+poly2sym(str2sym('[0 0]'))/poly2sym(str2sym('[1/tau 1]'));
Z_d=eval(Z_d)
